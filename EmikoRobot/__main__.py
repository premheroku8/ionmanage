...
PM_START_TEXT = """
*👋🏻 ʜᴇʟʟᴏ {} *
ɴᴀᴍᴀ ᴋᴜ ᴀᴅᴀʟᴀʜ ʏᴜɪɪ  [✨](https://telegra.ph/file/93da545de4dfdb76b1127.jpg)
ᴀᴋᴜ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴍᴀɴᴀɢᴇ + ᴍᴜsɪᴄ ᴀᴋᴜ ᴅɪ ʙᴜᴀᴛ ᴜɴᴛᴜᴋ ᴍᴇɴɢᴇʟᴏʟᴀ ᴅᴀɴ ᴍᴇᴍᴜᴛᴀʀ ᴍᴜsɪᴄ ᴅɪ ɢʀᴏᴜᴘ ᴀɴᴅᴀ ᴅᴇɴɢᴀɴ ʙᴇʀʙᴀɢᴀɪ ғɪᴛᴜʀ ♨.
────────────────────────
◈ *ᴜᴘᴛɪᴍᴇ:* `{}`
...
buttons = [
    ...
    [   
        InlineKeyboardButton(text="💌 ɢʀᴏᴜᴘ", url="t.me/YuiiSupportChat"
        ),
        InlineKeyboardButton(
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"👋ʜᴀɪɪ ᴀᴋᴜ ʏᴜɪɪ ᴀᴋᴜ sᴇɴᴀɴɢ ʙᴇʀᴛᴇᴍᴜ ᴅᴇɴɢᴀɴ ᴍᴜ",
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            "\npilih menu di bawah ini untuk melihat bantuan Music Yuii ",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1252482197:
            update.effective_message.reply_text(
                "Saya bebas untuk semua orang  Jika Anda ingin membuat saya tersenyum, bergabung saja"
