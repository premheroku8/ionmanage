            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/zennihhh"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/YuiiSupportChat")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update, context):
    ...
    status = "╒═══「 *Yuii Robot Statistik Sistem*: 」\n\n"
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n╘══ 「Powered By: [Yuii Robot](https://t.me/YuiichiroManage_Bot) 」\n\n",
        ...
        update.effective_message.reply_text(
            (
                ...
                + "╘══「 Powered By: [Yuii Robot](t.me/YuiichiroManage_BOT) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
